...
# Pairwise adonis
pairwise.adonis2(as.matrix(abund_soil)~Fertilizer, data = data.frame(sample_data(Soil_only)), nperm = 999)
...
ggsave("Figures/Plots/Fig_S11.png",dpi = 300)
...
# This is also non-rarefied data
ordination_data<-readRDS("Diversity_Analysis_Results/Non_Rarefied_Genus/full_analysis_results.rds")
